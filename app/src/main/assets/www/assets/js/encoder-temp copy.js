...
function get_members(memData) {
    ...
    $.each(memData, function (i, item) {
        ...
        table_contents.push('    <td>' + item.memindex + item.lname + ', ' + item.fname + ' ' + item.mname + '</td>');
...
function get_deceased(deceasedData) {
    ...
    $.each(deceasedData, function (i, item) {
        c.push('<tr>');
        c.push('    <td>' + item.dindex + item.dlname + ', ' + item.dfname + ' ' + item.dmname + '</td>');
